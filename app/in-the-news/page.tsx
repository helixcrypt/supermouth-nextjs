...
const additionalMedia = [
  ...
  { img: '/press/askmen.jpg', outlet: 'AskMen', outletColor: '#cc3300', headline: '2025 AskMen Grooming Awards Ñ Best Sonic Toothbrush', href: 'https://www.askmen.com/grooming/skin/grooming-awards-2025-face-care-products.html' },
...
export default function InTheNewsPage() {
  ...
  return (
    <div className="bg-sm-bg text-sm-navy">
      ...
      {/* Hero Ñ quotes are baked into the image, no overlays needed */}
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              { icon: '?', title: 'SuperMouth Pro', desc: 'Dental and medical professionals Ñ explore how you can partner with us to bring revolutionary oral care solutions to your patients. Discover more here.', cta: 'Join SuperMouth Pro', href: 'https://supermouthpro.com' },
