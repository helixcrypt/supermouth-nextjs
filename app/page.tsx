...
const ageCategories = [
  { label: 'Kids', tag: 'FOR KIDS', href: '/collections/shop-all-kids', img: '/cdn/toothbrush-category.png', desc: 'Complete care for growing smiles — safe, fun products from first teeth to preteens.', bg: 'bg-sm-peach' },
  { label: 'Teens & Adults', tag: 'FOR TEENS & ADULTS', href: '/collections/ages-13-and-up', img: '/cdn/hero-teens.png', desc: 'Complete daily care for confident smiles — advanced products for every routine.', bg: 'bg-sm-teal-bg' },
  { label: 'Orthodontics', tag: 'FOR ORTHODONTICS', href: '/collections/ortho', img: '/cdn/hero-ortho.png', desc: 'Complete ortho care for braces, aligners, and retainers — protect smiles in transition.', bg: 'bg-blue-100' },
  { label: 'Pregnancy', tag: 'FOR PREGNANCY', href: '/collections/pregnancy', img: '/cdn/mouthwash-category.png', desc: 'Safe, complete oral care through pregnancy and nursing — support for you and baby.', bg: 'bg-purple-100' },
]

const systems = [
  { label: 'Teething to 24 Months', href: '/systems/teething-to-24-months', img: '/cdn/system-0-24.png' },
  { label: 'Ages 2-5', href: '/systems/2-to-5', img: '/cdn/system-2-5.png' },
  { label: 'Ages 6-12', href: '/systems/6-to-12', img: '/cdn/system-6-12.png' },
  { label: 'Teens & Adults', href: '/systems/teens-and-adults', img: '/cdn/system-teens-adults.png' },
  { label: 'Pregnancy', href: '/systems/pregnancy', img: '/cdn/system-pregnancy.png' },
  { label: 'Orthodontics', href: '/systems/orthodontics', img: '/cdn/system-ortho.jpg' },
]

const superDifference = [
  { letter: 'S', word: 'SAFE', img: '/cdn/super-safe.png', href: '/learn/a-guide-to-understanding-oral-care-ingredient-safety', desc: 'Nothing mouthrageous - no artificial flavors, colors, sweeteners, or preservatives. Every ingredient rated #1 for safety by EWG.' },
  { letter: 'U', word: 'UNIFIED', img: '/cdn/super-unified.png', href: '/learn/beyond-brushing-flossing-a-comprehensive-guide-to-supercharging-your-oral-care-routine', desc: 'Each product designed for a specific purpose — together forming a complete system for kids, adults, pregnancy, and orthodontics.' },
  { letter: 'P', word: 'PLAYFUL', img: '/cdn/super-playful.png', href: '/learn/taking-the-bore-and-chore-of-brush-time', desc: 'SuperMouth Squad superheroes turn brushing into an adventure with movies, music, comic books, augmented reality, and delicious flavors.' },
  { letter: 'E', word: 'EFFECTIVE', img: '/cdn/super-effective.png', href: '/learn/are-your-oral-care-products-actually-working', desc: 'Over 200 expertly developed products and nearly 300 patents. Nano-hydroxyapatite, prebiotics, vitamins — results you can feel.' },
  { letter: 'R', word: 'REPUTABLE', img: '/cdn/super-reputable.png', href: '/learn/who-s-claiming-your-oral-care-products-work-because-it-matters-1', desc: 'Developed by top dentists and medical experts, trusted by thousands of dental professionals nationwide.' },
]
...
export default function HomePage() {
  return (
    <div className="bg-sm-bg text-sm-navy">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <h1 className="font-display font-black text-4xl md:text-5xl leading-tight mb-6 text-sm-navy">
              Your family does not need a better toothpaste. They need a{' '}
            ...
            <p className="text-sm text-sm-gray leading-relaxed mb-8">
              ...
              — Babies &amp; Toddlers, Little Kids, Big Kids, Teens &amp; Adults, Pregnancy, and Orthodontics. That is why{' '}
            ...
            <div className="flex flex-wrap gap-3 mb-5">
              ...
              <Link href="/systems-overview" className="bg-sm-purple text-white font-bold px-6 py-3 rounded-xl text-sm hover:opacity-90 transition-opacity">
                Shop Systems
                <span className="block text-xs font-normal opacity-80">Everything you need in one box - Save 15%</span>
              </Link>
            </div>
      ...
      {/* PRESS TICKER — same component as In The News page */}
      <PressLogoTicker />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { img: '/cdn/get-started-1.jpg', title: 'Let Us Guide You', desc: 'Take a quick quiz and get a custom plan from our experts — with oral care products tailored to your age, stage, and needs.', cta: 'Take Assessment', href: '/assessment' },
            { img: '/cdn/get-started-2.jpg', title: 'Shop Systems', desc: 'Embrace revolutionary care with our expert-curated systems, tailored for every age and stage, offering best-in-class options for all budgets.', cta: 'Shop Systems', href: '/systems-overview' },
            { img: '/cdn/get-started-3.jpg', title: 'Shop Products', desc: 'Discover our nearly 200 groundbreaking products designed for all ages. Each item represents the pinnacle of innovation in oral care.', cta: 'Shop Products', href: '/shop-all' },
          ].map(item => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="group rounded-2xl overflow-hidden bg-sm-peach">
              <div className="relative h-60 overflow-hidden">
                <Image src="/cdn/shop-by-age-kids.jpg" alt="Kids" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="p-6">
            ...
            <div className="group rounded-2xl overflow-hidden bg-sm-teal-bg">
              <div className="relative h-60 overflow-hidden">
                <Image src="/cdn/shop-by-age-adults.jpg" alt="Adults" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="p-6">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <Link href="/play" className="relative inline-block group">
          <div className="relative w-full max-w-2xl mx-auto rounded-2xl overflow-hidden shadow-lg">
            <Image src="/cdn/trosm-teaser.jpg" alt="Rise of SuperMouth" width={800} height={450} className="rounded-2xl group-hover:opacity-90 transition-opacity" />
